<nav x-data="{ open: false }" class="border-b border-gray-100 font-sans">
        ...
        <div class="flex justify-between h-16">
            <div class="flex h-full">
                ...
                <div class="shrink-0 flex items-center h-full">
                    <a href="{{ route('home') }}" class="h-full">
                        <x-application-logo class="block h-full py-2" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-bold text-gray-100 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-gray-500 hover:bg-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t bg-gray-100 bg-opacity-50 border-gray-200">
            <div class="px-4">
